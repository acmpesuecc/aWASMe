...
//Note: do not change the order that the structures have been defined in, since the structures coming later have dependecies in the structures coming first

//Different types of arguments in InstrArgs
struct BlockInfo 
{
...
using InstrArgs = std::variant<Value, BlockInfo, IfStruct>;

//Instruction data structure components
